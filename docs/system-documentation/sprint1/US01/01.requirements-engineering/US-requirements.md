...
1.6. System Sequence Diagram (SSD)
    ...
    Editor requests to create a map
    System requests map name
    Editor inputs map name
    System requests map size (width and height)
    Editor inputs map size
    System validates and creates the map
