...
* MATCP user stories are in the [matcp.ipynb](matcp.ipynb). Their docs are in [docs/system-documentation/sprint2/](docs/system-documentation/sprint2) folder in their respective US folder name 
* For MDISC, run de [Main.java](src/main/java/pt/ipp/isep/dei/Main.java) file and interact with the program
